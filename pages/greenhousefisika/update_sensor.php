...
$query =mysqli_query($mysqli, "UPDATE `sensor` SET `id`=id,`kadar_n`=kadar_n,`kadar_p`=kadar_p,`kadar_k`=kadar_k,`kelem_t`=kelem_t,`suhu_u`=suhu_u,`kelem`=kelem,`ph_tanah`=ph_tanah,`flow`=$flow WHERE 1");
$query =mysqli_query($mysqli, "UPDATE `sensor` SET `id`=id,`kadar_n`=kadar_n,`kadar_p`=kadar_p,`kadar_k`=kadar_k,`kelem_t`=kelem_t,`suhu_u`=suhu_u,`kelem`=kelem,`ph_tanah`=$ph_tanah,`flow`=flow WHERE 1");
$query =mysqli_query($mysqli, "UPDATE `sensor` SET `id`=id,`kadar_n`=kadar_n,`kadar_p`=kadar_p,`kadar_k`=kadar_k,`kelem_t`=kelem_t,`suhu_u`=suhu_u,`kelem`=$kelem,`ph_tanah`=ph_tanah,`flow`=flow WHERE 1");
$query =mysqli_query($mysqli, "UPDATE `sensor` SET `id`=id,`kadar_n`=kadar_n,`kadar_p`=kadar_p,`kadar_k`=kadar_k,`kelem_t`=kelem_t,`suhu_u`=$suhu_u,`kelem`=kelem,`ph_tanah`=ph_tanah,`flow`=flow WHERE 1");
$query =mysqli_query($mysqli, "UPDATE `sensor` SET `id`=id,`kadar_n`=kadar_n,`kadar_p`=kadar_p,`kadar_k`=kadar_k,`kelem_t`=$kelem_t,`suhu_u`=suhu_u,`kelem`=kelem,`ph_tanah`=ph_tanah,`flow`=flow WHERE 1");
