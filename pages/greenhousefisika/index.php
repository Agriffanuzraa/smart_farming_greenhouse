...
<html>
	...
	<head>
		...
		<title>Data sensor Smart Farming</title>
	...
	<body>
    <div class="header">
        <h1>SELAMAT DATANG PADA WEBSITE GREENHOUSE FISIKA</h1>
        <h1>FAKULTAS MIPA UNIVERSITAS LAMPUNG</h1>
    </div>
        <br>
        <!-- Add the image below the header -->
        <img src="fisika.png" alt="gambar greenhouse">
</body>

	
	<body>
	    <div >
	    <h1 style="font-size : 20px">Penelitian ini dilakukan oleh : </h1>
	    <h1 style="font-size : 20px">Agriffa Nuzra Djolanda</h1>
	    <h1 style="font-size : 20px">Oktavia Nur Azizah</h1>
	    <h1 style="font-size : 20px">Kharisma Rozikin</h1><br>
		<h1 style="font-size : 25px">Berikut Data Monitoring Tanaman Cabai</h1>
		</div>
	</body>
